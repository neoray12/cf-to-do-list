...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/cf-to-do-list#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cf-to-do-list
```

A live public deployment of this template is available at [https://cf-to-do-list.templates.workers.dev](https://cf-to-do-list.templates.workers.dev)
